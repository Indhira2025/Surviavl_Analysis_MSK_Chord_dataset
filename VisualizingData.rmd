...
sv[Sample_Id %in% filtered_samples()$SAMPLE_ID]
...
Show top 10 mutated genes × samples, colored by mutation type. Facet or group by cancer type. (Maybe just for a subset of patients!)
...
Pick two samples with different CNA patterns and plot them stacked for comparison. Maybe: Add gene annotations for known oncogenes/tumor suppressors at their chromosomal positions.
